...
/**
 * 
 * @author Anuj Blog www.goldenpackagebyanuj.blogspot.com RSA - Encrypt Data
 *         using Public Key RSA - Descypt Data using Private Key
 */
public class RSAEncryptionDescription {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			byte[] encryptedData = rsaObj
					.encryptData("Anuj Patel - Classified Information !");
